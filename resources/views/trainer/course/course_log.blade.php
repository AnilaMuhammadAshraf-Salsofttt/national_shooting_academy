    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-12 d-flex justify-content-between align-items-center flex-column flex-md-row ">
                ...
                <a href="{{ route('course.create')  }}" class="create_btn">Create New</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu table_menu">
                                         <a class="dropdown-item" href="{{ route('course.create',$course_logs->id) }}"><i class="fa fa-eye"></i>Course Edit </a>
                                         <a class="dropdown-item" href="{{ route('course.view_quiz',$course_logs->id) }}"><i class="fa fa-eye"></i>View Quiz </a>
                                         <a class="dropdown-item" href="{{ route('course.enrolled_user',$course_logs->id) }}"><i class="fa fa-eye"></i>Course Endrolled Users </a>
                                    </div>
                                </td>
