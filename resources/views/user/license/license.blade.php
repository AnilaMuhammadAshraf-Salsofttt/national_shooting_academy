    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-12 d-flex justify-content-between align-items-center flex-column flex-md-row ">
                <h5 class="i_t mb-0">License Categories</h5>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="lic-card">
                    <img src="{{ asset('user_asset/images/laycaanse.png') }}" alt="">
                    <div class="foot">
                        <h5>Category {{ $licenses->category->name }}</h5>
                        <a href="{{ url('user_license_detail/'.$licenses->id) }}">Apply</a>  
                    </div>
                </div>
            </div>
            @endforeach
            ...
            {{-- <div class="col-lg-4 col-md-6 col-12">
                <div class="lic-card">
                    <img src="images/laycaanse.png" alt="">
                    <div class="foot">
                        <h5>Category A</h5>
                        <a href="u-licenseDetails.php">Apply</a>  
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
