                    ...
                    <form action="{{ url('user_auth') }}" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="@error('email') is-invalid @enderror form-control" id="login_email" placeholder="Enter Email Address">
                                    @error('email')
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="@error('password') is-invalid @enderror form-control" id="logininput" placeholder="Enter Password">
                                    @error('password')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-row">
                            <div class="col-12 d-flex justify-content-between align-items-center mobile-flex">
                                ...
                                <a href="{{route('user.recover.password')}}" class="forgot_link">Forgot Password?</a>
                            </div>
                        </div>
