                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div
                                            ...
                                            <a href="{{ url('add_product') }}" class="bluee-btn mt-2 mt-md-0">ADD PRODUCT</a>
                                    ...
                                    <div class="row">
                                        <div
                                            class="col-12 d-flex justify-content-between align-items-center flex-column flex-md-row ">
                                            <h1 class="in-heading">Product Listing</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div class="top mt-5">
                                        ...
                                        <form action="{{ url('inventory_management') }}" method="GET">
                                                    ...
                                                    <td>
                                                        <div class="btn-group mr-1 mb-1">
                                                            ...
                                                            <div class="dropdown-menu" x-placement="bottom-start">
                                                                <a class="dropdown-item" href="{{ url('view_product/'.$item->id) }}"><i
                                                                        class="fa fa-eye"></i>View</a>
                                                                <a class="dropdown-item" href="{{ url('edit_product/'.$item->id) }}"><i
                                                                        class="fas fa-edit"></i>Edit</a>
                                                                <a class="dropdown-item" onclick="return confirm('Do you Want to Dlete...!')" href="{{ url('delete_product/'.$item->id) }}"><i
