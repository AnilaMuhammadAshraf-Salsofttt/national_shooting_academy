                            ...
                            <form action="{{ url('updatePassword') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12 form-group mb-2">
                                        <input type="hidden" class="form-control" value="{{ Request::segment(2) }}" placeholder="Enter Email Address" name="email" readonly>
                                    ...
                                    <div class="col-12 form-group mb-2">
                                        <input type="text" class="form-control" placeholder="Enter password confirmation" name="password_confirmation">
                                        <i class="fa fa-envelope"></i>
                                    </div>
                                </div>
                                ...
                                <a href="{{ url('/') }}" class="bcktologin"> <img src="{{ url('admin_asset/images/right-arrow.png') }}" alt=""> back to
                                    website</a>
