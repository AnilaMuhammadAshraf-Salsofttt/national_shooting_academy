                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-between align-items-center flex-column flex-md-row ">
                                            <h1 class="in-heading">BLOCKED TRAINERS</h1>
                                    ...
                                    <div class="top mt-5">
                                        ...
                                        <form action="{{ url('block_trainer_user') }}" method="GET">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 text-center">
                                                                    <h1 class="modal-h1">UnBlock User</h1>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12 text-center">
                                                                    <p class="txt">Are you sure you want to <br> Unblock the user?</p>
                                                                </div>
                                                            </div>
                                                            <div class="row">
