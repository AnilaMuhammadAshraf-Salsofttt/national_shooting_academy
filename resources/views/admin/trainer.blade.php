                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div
                                            ...
                                            <h1 class="in-heading">trainer listing</h1>
                                            <a href="{{ url('block_trainer_user') }}" class="bluee-btn mt-2 mt-md-0">Blocked
                                                Trainers</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="top mt-5">
                                        ...
                                        <form action="{{ url('trainer') }}" method="GET">
                                                ...
                                                <td>
                                                    <div class="btn-group mr-1 mb-1">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start">
                                                            <a class="dropdown-item" href="{{ url('user_trainer_profile/'.$item->id) }}"><i class="fa fa-eye"></i>View</a>
                                                            <a class="dropdown-item" href="{{ url('user_edit_trainer_profile/'.$item->id) }}"><i class="fas fa-edit"></i>Edit</a>
                                                            ...
                                                            <a class="dropdown-item" href="{{ url('trainer_sub_logs/'.$item->id) }}"><i class="fas fa-envelope"></i>SUBSCRIPTION log</a>
                                                            <a class="dropdown-item" href="{{ url('trainer_course/'.$item->id) }}"><i class="fas fa-clipboard-list"></i>course log</a>
                                                        </div>
                                                    </div>
                                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p class="txt">Are you sure you want to <br> block this trainer?</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 d-flex justify-content-center align-items-center">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p class="txt">trainer block successfully!</p>
                    </div>
                </div>
                <div class="row">
...
$(document).ready(function(){
    ...
    $.ajax({
        url:"{{ url('chnage_status_trainer_block') }}",
