                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Course A</td>
                                                    <td>$123</td>
                                                    <td>Active <i class="fas fa-angle-down" data-toggle="dropdown"
                                                    ...
                                                    <td>
                                                        <div class="btn-group mr-1 mb-1">
                                                            ...
                                                            <div class="dropdown-menu" x-placement="bottom-start">
                                                                <a class="dropdown-item" href="user-details.php"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Course A</td>
                                                    <td>$123</td>
                                                    <td>Inctive <i class="fas fa-angle-down" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false"></i>
                                                        <div class="dropdown-menu" x-placement="bottom-start">
